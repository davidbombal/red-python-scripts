...
command_output = subprocess.run(["netsh", "wlan", "show", "profiles"],
                                capture_output=True, stdin=subprocess.DEVNULL).stdout.decode()
    ...
    for name in profile_names:
        ...
        if re.search("Security key           : Absent", profile_info):
            ...
            profile_info_pass = subprocess.run(
                ["netsh", "wlan", "show", "profile", name, "key=clear"], capture_output=True, stdin=subprocess.DEVNULL).stdout.decode()
